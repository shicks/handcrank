...
export const globals = new Map<string, Intrinsic>([
  ['AggregateError', Intrinsics.AggregateError],
  ['Array', Intrinsics.Array],
  ['ArrayBuffer', Intrinsics.ArrayBuffer],
  ['Atomics', Intrinsics.Atomics],
  ['BigInt', Intrinsics.BigInt],
  ['BigInt64Array', Intrinsics.BigInt64Array],
  ['BigUint64Array', Intrinsics.BigUint64Array],
  ...
  ['FinalizationRegistry', Intrinsics.FinalizationRegistry],
